...
public class Librarian extends BillNumber {
	...
	public final ArrayList<Date> datesSold;
	public final ArrayList<Double> moneyMadeDates;
	...
	public Librarian(String username, String password, String name, double salary, String phone, String email){
